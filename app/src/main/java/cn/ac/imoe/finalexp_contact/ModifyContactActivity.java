...
public class ModifyContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contacts c = queryForModify(intent.getStringExtra("dphone"));
        ...
        btn_mod_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SQLiteDatabase db = helper.getReadableDatabase();
                 ...
                 db.update("contact",cv,"dphone="+ori_phone,null);
                 db.close();
    ...
    private contacts queryForModify(String dphone){
        JK8Helper helper = new JK8Helper(ModifyContactActivity.this,"s.db",null,1);
        SQLiteDatabase db = helper.getReadableDatabase();
        Cursor cursor = db.query("contact",new String[]{"dphone","dname","academy","bestfriend","gender"}, "dphone="+dphone
                ,null,null,null,"dphone");
        cursor.moveToNext();
